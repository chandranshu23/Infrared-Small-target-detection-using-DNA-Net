...
#from model.model_DNANet    import  ACM
...
def parse_args():
    ...
    parser.add_argument('--img_demo_dir', type=str, default='img_demo',
                        help='img_demo')
    parser.add_argument('--img_demo_index', type=str,default='Misc_90',
...
class Trainer(object):
    def __init__(self, args):
        ...
        # Load Checkpoint
        checkpoint      = torch.load('mIoU__DNANet_IRSTD-1k_epoch.pth.tar')
